...
function avviaGioco() {
    ...
    for (let i = 0; i < 1; i++) {
        ...
        for (let i2 = 0; i2 < (giocatori.getGiocatori()[i].getNumeroSchedine() - Math.floor(giocatori.getGiocatori()[i].getNumeroSchedine() / 2)); i2++) {
            ...
            schedina.className = "schedina col";
            schedina.id = i + "_" + i2;
...
function terminaTurno() {
    ...
    console.log(giocatori.getArrayAmbo());
...
function aggiornaTabellaTempoReale() {
    ...
    console.log(utentiOrdinatiPunti);
...
function creaClassifica() {
    ...
    for (var i = 1; i < clasificaDinamica.rows.length; i++) {
        clasificaDinamica.deleteRow(i);
    }
...
function RiscattaPremioNuovo(num) {
    ...
    if (giocatori[0].getTombola().getRiscattato() == true && tombolaGlobale == true) {
        ...
        } else if (giocatori[0].getAmbo().getRiscattato() == true && cinquinaGlobale == true) {
            cinquinaGlobale = false;
            let schermataLog = document.getElementById("log");
